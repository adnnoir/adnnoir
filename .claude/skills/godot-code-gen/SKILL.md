---
name: godot-code-gen
description: Génère du GDScript Godot 4.x propre et idiomatique (typage statique, signaux, @export, @onready, patterns de jeu). À utiliser dès qu'on écrit ou modifie des scripts .gd pour un projet Godot.
---

<!-- Source : https://github.com/alexmeckes/godot-claude-skills (licence dans le dépôt d'origine) -->
