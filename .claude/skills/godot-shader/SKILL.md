---
name: godot-shader
description: Écrit des shaders Godot 4.x (.gdshader) : matériaux 3D, effets 2D, post-process (vision, flou, grain, dissolve). À utiliser pour tout effet visuel ou shader dans Godot.
---
