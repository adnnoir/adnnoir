...
description: Conçoit des scènes Godot 4.x (.tscn), hiérarchies de nœuds et niveaux (joueur FPS, ennemis, arènes, UI). À utiliser pour créer ou restructurer des scènes et des nœuds Godot.
---
